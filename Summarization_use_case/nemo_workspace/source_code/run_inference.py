...
prompt0 = ["### Instruction: Write a summary of the conversation below. ### Input: user: looking to change my flight Friday, Oct 27. GRMSKV to DL4728 from SLC to ORD. Is that an option and what is the cost? Jess\nagent: The difference in fare is $185.30. This would include all airport taxes and fees. The ticket is non-refundable changeable with a fee, *ALS and may result in additional fare collection for changes when making a future changes. *ALS\nuser: I had a first class seat purchased for the original flight, would that be the same with this flight to Chicago?\nagent: Hello, Jess. That is the fare difference. You will have to call us at 1 800 221 1212 to make any changes. It is in First class. *TAY\nuser: thx\nagent: Our pleasure. *ALS\nuser: Do I have to call or is there a means to do this online?\nagent: You can call or you can login to your trip on our website to make changes."]

prompt = "### Instruction: Can you summarize the text below into these sections: Summary, Main issue, Urgency, Attempted solution, Sentiment, and Suggested action. ### Input: user: looking to change my flight Friday, Oct 27. GRMSKV to DL4728 from SLC to ORD. Is that an option and what is the cost? Jess\nagent:\
         The difference in fare is $185.30. This would include all airport taxes and fees. The ticket is non-refundable changeable with a fee, *ALS and may result in additional fare collection for changes when making a future changes. *ALS\nuser:\
         I had a first class seat purchased for the original flight, would that be the same with this flight to Chicago?\nagent: Hello, Jess. That is the fare difference. You will have to call us at 1 800 221 1212 to make any changes.\
         It is in First class. *TAY\nuser: thx\nagent: Our pleasure. *ALS\nuser: Do I have to call or is there a means to do this online?\nagent: You can call or you can login to your trip on our website to make changes."
...
if __name__ == "__main__":
    ...
    inference_params=CommonInferenceParams(temperature=0.2, top_p=0.7, num_tokens_to_generate=300),
    text_only=True,
    )
